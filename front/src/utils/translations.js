const translations = {
    ...
    "protocol_id": "ID протокола анализа",
    "substance_id": "ID вещества (ссылка)",
    "text": "Инфо о концентрации",
    "brand_name": "Марка прибора учета",
    "serial_number": "Серийный номер прибора",
    "verification_date": "Дата поверки",
    "verification_interval": "Интервал поверки (годы)",
    "next_verification_date": "Дата след. поверки",
    "organisation_code": "Код организации (ссылка)",
